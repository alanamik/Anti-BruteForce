...
// BlacklistDeleteInternalServerErrorBody blacklist delete internal server error body
//
// swagger:model BlacklistDeleteInternalServerErrorBody
type BlacklistDeleteInternalServerErrorBody struct {

	// ok
	Ok string `json:"ok,omitempty"`
}

// Validate validates this blacklist delete internal server error body
func (o *BlacklistDeleteInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this blacklist delete internal server error body based on context it is used
func (o *BlacklistDeleteInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *BlacklistDeleteInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *BlacklistDeleteInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res BlacklistDeleteInternalServerErrorBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
// BlacklistDeleteOKBody blacklist delete o k body
//
// swagger:model BlacklistDeleteOKBody
type BlacklistDeleteOKBody struct {

	// ok
	Ok string `json:"ok,omitempty"`
}

// Validate validates this blacklist delete o k body
func (o *BlacklistDeleteOKBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this blacklist delete o k body based on context it is used
func (o *BlacklistDeleteOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *BlacklistDeleteOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *BlacklistDeleteOKBody) UnmarshalBinary(b []byte) error {
	var res BlacklistDeleteOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
